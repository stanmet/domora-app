...
const TITLE_KEYWORDS: [RegExp, string][] = [
  [/газон|сад(?!ик)|двор|клумб|ландшафт|полив|растен|lawn|mow|garden|hedge|weed|planting|\bleaf/i, "gardening"],
  [/собак|выгул|питом|кошк|груминг|\bdog|\bpet|walking|groom|\bcat\b/i, "dog"],
  [/курьер|доставк|посылк|courier|deliver|parcel/i, "delivery"],
  [/переезд|перевоз|грузчик|\bmove|\bmoving|\bmover|removal|\bvan\b|junk|carry a sofa|furniture transport/i, "moving"],
  [/репетит|английск|математ|урок|обучен|\bязык|tutor|english|\bmath|\bexam|lesson|conversational/i, "tutoring"],
  [/маникюр|ногт|педикюр|manicure|pedicure|nails|gel polish/i, "manicure"],
  [/макияж|визаж|make-?up/i, "makeup"],
  [/бров|ресниц|\bbrow|eyebrow|lash/i, "brows"],
  [/стрижк|укладк|парикмах|волос|причёск|причес|haircut|\bhair|blow-?dry|styling/i, "haircut"],
  [/массаж|massage/i, "massage"],
  [/сантех|смесител|кран|труб|унитаз|засор|plumb|\btap\b|leak|toilet|drain|blockage|\bsink|washing machine/i, "plumbing"],
  [/электрик|проводк|розетк|светильник|electric|socket|switch|wiring|light fitting|\bhob\b|fault/i, "electrician"],
  [/мебел|сборк|полк|картин|телевизор|ремонт|навес|установк|карниз|handyman|furniture|assembl|shel(f|ves)|\btv\b|mount|repair|fitting|drill/i, "handyman"],
  [/диджей|\bdj\b/i, "dj"],
  [/фотограф|фотосъ|съёмк|съемк|photograph|\bphoto\b/i, "photographer"],
  [/аниматор|детск|entertainer|kids|children/i, "kids"],
  [/ведущ|юбилей|праздник|вечеринк|торжеств|свадьб|\bhost\b|anniversary|party|celebration|wedding|christening|birthday/i, "party"],
  [/уборк|убрать|окон|окна|мытьё|чист|клинин|clean|window|after-builders|office cleaning/i, "cleaning"],
  [/повар|ужин|меню|стейк|паст[аы]|готов|блюд|кейтеринг|\bеда|гриль|выпечк|chef|\bcook|dinner|\bmeal|steak|pasta|grill|bak(e|ing)|vegan|cater/i, "cooking"],
];
