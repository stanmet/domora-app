...
export const CATEGORY_PACKS: Record<string, CategoryPack> = {
  ...
  plumbing: {
    professions: ["Сантехник", "Plumber", "Мастер по сантехнике"],
    titles: [
      "Замена смесителя",
      "Устранение течи",
      "Установка унитаза",
    ...
    skills: ["Смесители", "Устранение течей", "Установка сантехники", "Прочистка засоров"],
    price: [3000, 7000],
    budget: [4000, 15000],
    tasks: ["Течёт кран на кухне", "Засор в раковине", "Установить унитаз"],
  },
  electrical: {
    professions: ["Электрик", "Electrician", "Мастер-электрик"],
    titles: [
    ...
    skills: ["Розетки и выключатели", "Освещение", "Проводка", "Поиск неисправностей"],
    price: [3000, 7000],
    budget: [4000, 15000],
    tasks: ["Не работает розетка", "Повесить и подключить люстру", "Проверить проводку"],
  },
  gardening: {
    professions: ["Садовник", "Gardener", "Мастер по саду"],
    titles: [
      "Стрижка газона",
      "Уход за садом и клумбами",
      "Обрезка кустов и деревьев",
      "Уборка листьев",
      "Посадка растений",
    ],
    skills: ["Стрижка газона", "Обрезка", "Уход за клумбами", "Уборка участка"],
    price: [1800, 5000],
    budget: [3000, 12000],
    tasks: ["Постричь газон", "Убрать листья в саду", "Обрезать кусты"],
  },
  petcare: {
    professions: ["Догситтер", "Pet sitter", "Специалист по уходу за питомцами", "Грумер"],
    titles: [
      "Выгул собаки",
      "Передержка питомца",
      "Груминг собаки",
    ...
    skills: ["Выгул", "Передержка", "Груминг", "Кормление"],
    price: [1500, 4000],
    budget: [2000, 9000],
    tasks: ["Выгулять собаку", "Присмотреть за котом на выходных", "Помыть и подстричь собаку"],
  },
  moving: {
    professions: ["Грузчик", "Mover", "Служба переезда", "Водитель с грузовиком"],
    titles: [
      "Помощь с переездом",
      "Перевозка мебели",
      "Грузчики на час",
      "Вывоз старой мебели и мусора",
    ],
    skills: ["Переезды", "Погрузка", "Перевозка мебели", "Вывоз хлама"],
    price: [3000, 8000],
    budget: [5000, 25000],
    tasks: ["Перевезти вещи в новую квартиру", "Помочь занести диван", "Вывезти старую мебель"],
  },
  tutoring: {
    professions: ["Репетитор", "Tutor", "Преподаватель"],
    titles: [
    ...
    skills: ["Английский", "Математика", "Подготовка к экзаменам", "Работа с детьми"],
    price: [2000, 5000],
    budget: [3000, 12000],
    tasks: ["Позаниматься английским с ребёнком", "Помочь с математикой", "Подготовить к экзамену"],
  },
  other: {
    professions: ["Помощник по дому", "Курьер", "Разнорабочий"],
    titles: [
    ...
    skills: ["Помощь по дому", "Доставка", "Мелкий ремонт", "Разные поручения"],
    price: [1500, 5000],
    budget: [2000, 10000],
    tasks: ["Помочь по хозяйству", "Отвезти посылку по городу", "Разные мелкие поручения"],
  },
};
